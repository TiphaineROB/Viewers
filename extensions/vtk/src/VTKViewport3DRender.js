...
const { xhrRetryRequestHook} = utils;
...
class VTKViewport3DRender extends Component {
  state = {
  ...
  async componentDidMount() {
    ...
    const searchInstanceOptions = { studyInstanceUID }
  ...
  render() {
    ...
    return (
      <div className="vtk-viewport-handler" style={style}>
          <select
...
VTKViewport3DRender.propTypes = {
  url: PropTypes.string, //.isRequired,
  studyInstanceUID: PropTypes.string, //.isRequired,
  SeriesInstanceUID: PropTypes.string, //.isRequired,
};

export default VTKViewport3DRender;
